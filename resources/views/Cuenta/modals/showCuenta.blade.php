...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{route('cuenta.index')}}">Listado de cuentas</a></li>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                      ...
                      {{-- Detalle de las cuentas para el administrador  --}}
                      <div class="form-group row">
                        <label for="email"
                          class="col-md-5 col-form-label text-md-right">{{ __('Empresa:') }}</label>
                        <div class="col-md-6">
                          <label id="email"
                            class="col-md-10 col-form-label text-md-leftt">{{ $userShow->email }}</label>
                        </div>
