...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('home')}}">
                ...
                <div class="sidebar-brand-text mx-3">SIANF </div>
            </a>
          ...
          <!--  <li class="nav-item active">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    ...
                    @endcan
                    @can('rol.index')
                    <a class="collapse-item" href="{{route('rol.index')}}">Roles y permisos</a>
                    @endcan
                    @can('logs.index')
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages50" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('analisis.vertical') }}">Analisis vertical</a>                        
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages67" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Sectores</h6>
                        <a class="collapse-item" href="{{ route('sectores.index') }}">Sectores</a>
                    </div>
                </div>
            </li>
            @endcan
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Content Row/ Tarjetas superiores -->
                   <!-- <div class="row">
